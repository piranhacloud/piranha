...
Web Profile you can start here!
...
```bash
  java -jar piranha-dist-web-profile.jar --war-file helloworld.war
```

## Conclusion

As you can see getting started with Piranha Web Profile takes (almost) no effort!
